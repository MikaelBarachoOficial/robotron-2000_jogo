...
ajuste.forEach(elemento => {
    elemento.addEventListener('click', evento => {
        ...
        //mudaEstatistica(sinal ,evento.target.dataset.peca);
...
// function mudaEstatistica (sinal, peca) {
//     estatisticas.forEach(estatistica => {
//         //console.log(estatistica.dataset.estatistica)
//         //console.log(estatistica.textContent)
        
//         //console.log(pecas[peca]); //retorna conteudo do objeto
//         //console.log(estatistica.dataset.estatistica); //retorna nome; valor do data-estatistica no index.html 
            
//         const nome = estatistica.dataset.estatistica;
//         let numero = estatistica.textContent;

//         //console.log(numero);
//         //console.log(pecas[peca][nome]);
